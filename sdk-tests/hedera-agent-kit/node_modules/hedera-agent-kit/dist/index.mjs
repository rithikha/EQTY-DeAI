...
import { Hbar, PublicKey, TokenSupplyType, TokenType } from "@hashgraph/sdk";
...
var HederaParameterNormaliser = class {
  static async normaliseCreateFungibleTokenParams(params, context, client, mirrorNode) {
    ...
    const supplyType = supplyTypeString === "finite" ? TokenSupplyType.Finite : TokenSupplyType.Infinite;
  ...
  static async normaliseCreateNonFungibleTokenParams(params, context, client, mirrorNode) {
    ...
    const normalized = {
      ...
      treasuryAccountId,
      maxSupply,
      supplyKey: PublicKey.fromString(publicKey),
...
import { z } from "zod";
import { TokenSupplyType as TokenSupplyType2, TokenType as TokenType2 } from "@hashgraph/sdk";
...
import { AccountId as AccountId2, Hbar as Hbar2 } from "@hashgraph/sdk";
...
var accountQueryParameters = (_context = {}) => z4.object({
  accountId: z4.string().describe("The account ID to query.")
});
var accountBalanceQueryParameters = (_context = {}) => z4.object({
  accountId: z4.string().optional().describe("The account ID to query.")
});
var accountTokenBalancesQueryParameters = (_context = {}) => z4.object({
  accountId: z4.string().optional().describe("The account ID to query. If not provided, this accountId will be used."),
  tokenId: z4.string().optional().describe("The token ID to query.")
});
